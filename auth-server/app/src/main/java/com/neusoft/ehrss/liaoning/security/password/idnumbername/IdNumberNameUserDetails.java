 ...
 *
 */
public class IdNumberNameUserDetails extends SaberUserDetails implements UserDetails {
	 ...
	 * @param u
	 */
	public IdNumberNameUserDetails(User u) {
		...
		super.setClientType("alipay");
		setId(u.getId());
	}

	public IdNumberNameUserDetails(ThinUser u) {
		super(u.getAccount(), u.getName(), u.getPassword());
		super.setMobile(u.getMobile());
		super.setIdNumber(u.getIdNumber());
		super.setSystemType(SystemType.Person.toString());
