...
/**
 * <p>GetCertInfoByOid complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="GetCertInfoByOid"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="oid" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0" form="qualified"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "GetCertInfoByOid", propOrder = {
    "appName",
    "base64EncodeCert",
    "oid"
})
public class GetCertInfoByOid {
