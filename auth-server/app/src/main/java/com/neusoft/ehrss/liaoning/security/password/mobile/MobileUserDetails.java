 ...
 *
 */
public class MobileUserDetails extends SaberUserDetails implements UserDetails {
	 ...
	 * @param u
	 */
	public MobileUserDetails(User u) {
		...
		super.setClientType(ClientType.Mobile.toString());
		setId(u.getId());
	}

	public MobileUserDetails(ThinUser u) {
		super(u.getAccount(), u.getName(), u.getPassword());
		super.setMobile(u.getMobile());
		super.setIdNumber(u.getIdNumber());
		super.setSystemType(SystemType.Person.toString());
