...
public class RlzyscPersonAuthenticationProvider extends DaoAuthenticationProvider {

	@Override
	public boolean supports(Class<? extends Object> authentication) {
		return (authentication.getSimpleName().equals(RlzyscPersonAuthenticationToken.class.getSimpleName()));
	}
