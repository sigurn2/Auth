...
public class AuthorizationCodeTokenGranter extends AbstractTokenGranter {
	...
	private static final Logger log = LoggerFactory.getLogger(AuthorizationCodeTokenGranter.class);
	...
	protected AuthorizationCodeTokenGranter(AuthorizationServerTokenServices tokenServices, AuthorizationCodeServices authorizationCodeServices, ClientDetailsService clientDetailsService,
	...
	protected OAuth2Authentication getOAuth2Authentication(ClientDetails client, TokenRequest tokenRequest) {
		...
		if ((redirectUri != null || redirectUriApprovalParameter != null) && !pendingOAuth2Request.getRedirectUri().equals(redirectUri)) {
			log.error("zhouhd。存储的getRedirectUri={},传入的redirectUri={}", pendingOAuth2Request.getRedirectUri(), redirectUri);
